plugins {
    ...
    // Micronaut 4.4's application plugin doesn't register shadowJar itself;
    // add it so the Dockerfile can copy a single build/libs/*-all.jar.
